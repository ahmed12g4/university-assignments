    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-3 p-3">
                ...
                {!collapsed && <span className="text-lg font-semibold text-slate-900 transition-colors dark:text-slate-50">UniAssignments</span>}
            </div>
                    ...
                    >
                        ...
                        {navbarLink.links.map((link) => (
                            <NavLink
                                ...
                                to={link.path}
                                className={({ isActive }) =>
                                    cn("sidebar-item", collapsed && "md:w-[45px]", isActive && "bg-slate-200 dark:bg-slate-700")
                                }
                            >
                                <link.icon
                                    size={22}
